...
//    (lib/broadcast/audience.ts) และถ้าแม่แบบดึงจาก "ลูกค้าในระบบ" ด้วย ต้องอยู่ใน
//    `CUSTOMER_AUDIENCE_KEYS` ของ lib/audiences/resolve.ts ด้วย — ไม่งั้นเซิร์ฟเวอร์
//    ปฏิเสธตอนบันทึก ("กลุ่มผู้รับนี้ใช้กับแหล่งข้อมูลที่เลือกไม่ได้")
