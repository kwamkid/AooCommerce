...
/**
 * ใบวางบิล (statements)
 * ⚠️ 'partially_paid' + 'overdue' **จองไว้สำหรับฟีเจอร์ที่จะทำ** (จ่ายบางส่วน / เกินกำหนด)
 *    — ห้ามลบทิ้งเพราะเห็นว่ายังไม่มีใครเขียน
 * 'draft' กลับมาแล้ว 17 ก.ย. 2026 พร้อมรอบวางบิล — ออเดอร์ขายขาดเครดิตถูกรวบเข้าใบ
 *    ของรอบเป็นฉบับร่าง ยอดยังวิ่งได้จนกว่าคนจะตรวจแล้วกดยืนยัน
 *    (เคยถอดออกตอน 20260908_statements_drop_dead_draft สมัยที่ 1 ออเดอร์ = 1 ใบ)
 */
const statement: Domain = {
  draft:          s('ฉบับร่าง', 'new'),
...
/** ใบรับเข้า / ใบเบิกออก / ใบคืนของ supplier — จบในตัว ไม่มีขั้นกลาง */
const stockDoc: Domain = {
  completed: s('สำเร็จ', 'done'),
  /** ใบคืนของ supplier ออกแล้วถือว่าจบ (ของออกจากคลังไปแล้ว) */
  issued: s('ออกใบแล้ว', 'done'),
  cancelled: s('ยกเลิก', 'off'),
};
