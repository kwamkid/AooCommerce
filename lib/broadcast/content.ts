...
/**
 * ป้ายบนตัวเลือกชนิด action (ActionPicker) ทุกที่ — ป้ายเต็มข้างบนพับเป็นสองบรรทัดในปุ่มจนล้นขอบบนล่าง
 * เมื่อจอแคบ แล้วเจ้าของขอให้ใช้ป้ายสั้นทุกจุด (11 ก.ย. 2026) · ป้ายเต็มเหลือใช้ใน tooltip และประโยคสรุป
 */
