...
// ใช้ร่วมกับหน้าอื่น (โปรโมชัน) ได้โดยไม่ต้องลากกติกาแถวตัวเลือกไปด้วย · re-export ไว้ให้ import เดิมยังใช้ได้
export { NO_REDUCE, applyReduce, reduceSummary, type ReduceMode, type ReduceSpec } from './price-reduce';
