    ...
    <div className="space-y-4">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-5">
        <div className="flex items-center justify-between mb-1">
          <label className="label">ตัวแทน</label>
          <button
            type="button"
        ...
        <FormSelect
          ...
          placeholder="เลือกตัวแทน (consignment dealer)"
        />
        {!selectedCustomerId && customers.length === 0 && (
          <p className="text-xs text-amber-600 dark:text-amber-400 mt-2">
            ไม่พบตัวแทนประเภท consignment dealer — กรุณาสร้างลูกค้าก่อน
          </p>
        )}
      </div>
      ...
      <div className="flex justify-end gap-3">
        <button
          type="button"
          onClick={() => router.push('/replenishments')}
          disabled={submitting}
