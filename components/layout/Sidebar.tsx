...
export default function Sidebar() {
  ...
  const settingsItems: { href: string; label: string; icon: React.ReactNode; isActive: boolean }[] = [
    ...
    ...(can(subject, 'chat.reply') ? [{ href: '/settings/quick-replies', label: 'ข้อความสำเร็จรูป', icon: <MessageSquareText className="w-[18px] h-[18px] flex-shrink-0" />, isActive: pathname === '/settings/quick-replies' }] : []),
