-- Updated get_product_for_edit RPC for marketplace architecture
-- Changes: shopee_accounts → marketplace_accounts, shopee_* fields → platform_data
    ...
    'marketplace_links', (
      SELECT COALESCE(json_agg(
        json_build_object(
          ...
          'account_name', COALESCE(ma.shop_name, mpl.account_name),
          'shop_id', ma.shop_id,
          ...
          'platform_data', mpl.platform_data,
      ...
      LEFT JOIN marketplace_accounts ma ON ma.id = mpl.account_id
