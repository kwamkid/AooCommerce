...
|---|---|---|
| **สำคัญสุด** (สีแบรนด์ + ตัวหนา) | `primary: true` — **1 รายการต่อ 1 เมนูเท่านั้น** | เมนูที่ **สร้างของใหม่ / ลัดขั้นตอน**: `พิมพ์ทั้งหมด` · `ออกใบกำกับแบบเต็ม` (สร้างใบใหม่ + void ใบย่อ) |
