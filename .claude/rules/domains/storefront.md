...
- **ชื่อลิงก์เปลี่ยนได้ครั้งเดียวทุก 7 วัน — แต่นับเฉพาะการเปลี่ยนที่เกิดตอนร้านเปิดอยู่** (`companies.storefront_slug_changed_at` · `STOREFRONT_SLUG_LOCK_DAYS` — ลดจาก 30 เมื่อ 2026-09-14) · ปิดร้านอยู่ = ยังไม่มีลิงก์ไหนอยู่ข้างนอก แก้คำที่พิมพ์ผิดได้อิสระ **และไม่ stamp เวลา** (stamp ตอนปิดร้านด้วย = เปิดร้านปุ๊บติดล็อกทันทีทั้งที่ยังไม่เคยส่งลิงก์ให้ใคร)
