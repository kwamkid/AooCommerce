...
| เลือกช่องทาง/บัญชี (ติ๊กได้หลายอัน + ค้นหา + รูปโปรไฟล์) | **`AccountPicker`** — ปุ่ม + ป๊อปอัป · รูปวาดด้วย `ChannelBadge` (มี fallback ให้แล้ว) | เรียงรายการติ๊กลงมาทั้งหมด (ร้านเดียวมีได้หลายสิบบัญชี — ABC the Baby มี FB 7 เพจ · Shopee 6 ร้าน) · เขียนป๊อปอัปเลือกบัญชีเองในหน้า (หน้าแชทมีของเดิมเขียนไว้ในหน้า ควรย้ายมาใช้ตัวนี้) |
