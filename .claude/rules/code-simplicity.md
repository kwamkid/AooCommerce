...
| `runBroadcast(id, platform)` | `lib/broadcast/run.ts` | จุดเดียวที่แปลง "ใบนี้อยู่ช่องทางไหน" เป็น "เรียกตัวส่งของใคร" — route ทั้งสามตัวเรียกผ่านนี่ **ห้ามเรียก `runLineBroadcast()` ตรง ๆ จาก route** |
