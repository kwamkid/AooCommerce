...
- **กลุ่มผู้รับอยู่ในโมดัลที่เดินเป็น 3 ขั้น** (`Stepper` ของกลาง — กลุ่ม → ตัวเลือก → กรองเพิ่ม) ไม่ใช่การ์ดเรียงยาวในหน้าหรือในโมดัล · ขั้น "กรองเพิ่ม" ข้ามไปเลยเมื่อเลือก `all`/`contacts_pick` (ไม่มีรายชื่อให้กรอง / เลือกมาเองแล้ว) — รายการจะยาวขึ้นเรื่อย ๆ (จะเพิ่ม "ไม่ได้ซื้อมา N วัน" · "ทักมาแต่ยังไม่เคยซื้อ") และบางตัวเลือกมีของให้กรอกต่อ (แท็ก · รายชื่อ · จำนวนวัน) ซึ่งยัดใน dropdown แล้วอึดอัด · ปุ่มบนหน้าโชว์ชื่อกลุ่ม + จำนวนผู้รับ/สิ่งที่ยังต้องเลือก
