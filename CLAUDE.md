...
- **หน้าสร้างเป็น 2 คอลัมน์บนจอกว้าง** — ซ้ายฟอร์ม (ส่งถึงใคร + เนื้อหา) · ขวาตรึงไว้ (จำนวนผู้รับ + โควตา + ตัวอย่าง + ปุ่มส่ง) เพราะจำนวนผู้รับกับตัวอย่างคือของที่ต้องเห็นตลอดเวลาที่แก้ข้อความ · ช่องทางที่ยังส่งไม่ได้ย่อเป็นบรรทัดเดียวกดกาง (กางค้างไว้ดันเนื้อหาจริงตกจอ) — **ย่อได้แต่ห้ามซ่อนหาย** ไม่งั้นผู้ใช้จะถามซ้ำว่าทำไมไม่มี Shopee
