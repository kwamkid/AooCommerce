...
- **แบบสุดท้าย**: กำหนดส่ง (+โซน) ย้ายขึ้นกล่องมุมขวาบนเป็นแถวที่ 3 ต่อจากเลขที่/วันที่ · บล็อกผู้รับเหลือ 2 คอลัมน์ [ป้าย | ค่า] **ทุกบรรทัด 10pt ตัวปกติ** (ป้ายสีเทา) จึงวางฐานบรรทัดตรงกันเองโดยไม่ต้องเล่นท่าอะไร · ที่อยู่ `lineHeight` 1.02 อยู่ในคอลัมน์ค่า · **หมายเหตุเป็นสิ่งเดียวที่หนา แต่ขนาดเท่าบรรทัดอื่น** (เด่นพอ ไม่ตะโกน)
