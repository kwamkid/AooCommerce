...
**🟠 ใบจัดของ — จัดบล็อกผู้รับใหม่ทั้งก้อน** (เจ้าของ: "บรรทัดไม่ตรงกัน ฟอนต์ไม่เท่ากัน ดูยาก · ที่อยู่เว้นบรรทัดสูงเกินจนเหมือนคนละข้อความ · หมายเหตุที่ควรเด่นกลับไม่เด่น"):
- **สาเหตุของ "บรรทัดไม่ตรงกัน" คือวางป้ายไว้ *คนละช่องตาราง* กับค่า** — pdfMake ชิดเนื้อหาขอบบนของแถว ป้าย 9pt กับชื่อ 13pt จึงอยู่คนละระดับเสมอ ไม่ว่าจะปรับ margin ยังไงก็ไม่ตรงทุกความยาว ⇒ **เปลี่ยนเป็นป้ายอยู่บรรทัดบน ค่าอยู่บรรทัดล่าง** (ซ้าย = ผู้รับ · ขวา = กำหนดส่ง) แล้วที่อยู่ไหลเต็มความกว้างข้างล่าง · ป้ายกับค่าที่ต้องอยู่บรรทัดเดียวกัน (หมายเหตุ) ยัดไว้ใน `text: [...]` **ก้อนเดียว** pdfMake วางฐานบรรทัดให้ตรงเอง
- ที่อยู่ `lineHeight` 1.15 → **1.02** และได้ความกว้างเต็มบล็อก (เดิมโดนบีบอยู่ในคอลัมน์ซ้าย เลยตัดบรรทัดบ่อย)
- หมายเหตุ 9pt สีเทา → **12pt ตัวหนาสีเข้ม + เส้นคั่นบาง** เด่นรองจากชื่อผู้รับ (สำหรับ aDay Fresh ช่องนี้คือรอบเวลาส่ง "WE.0909/10.30-11.00" ซึ่งสำคัญที่สุดของใบ)
...
- **ป้ายกับค่าที่ต้องอ่านคู่กัน ห้ามอยู่คนละเซลล์ตาราง** ถ้าขนาดตัวอักษรไม่เท่ากัน — อยู่บรรทัดเดียวกันให้ใช้ `text: [...]` ก้อนเดียว, อยู่คนละบรรทัดให้ป้ายอยู่บน
