...
export default function ColumnSettingsDropdown<T extends string>({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {show && (
        <div className={`absolute right-0 w-48 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg z-10 py-1 max-h-80 overflow-y-auto ${dropUp ? 'bottom-full mb-2' : 'mt-2'}`}>
