      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/50 rounded-lg border border-slate-700/50 p-6">
            <h2 className="text-lg font-semibold text-white mb-4">Companies แยกตาม Package</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {Object.entries(stats.packageCounts).length === 0 ? (
                <p className="text-slate-400 col-span-3">ยังไม่มี subscription</p>
              ) : (
          ...
          {/* Recent Companies */}
          <div className="bg-slate-800/50 rounded-lg border border-slate-700/50 p-6">
            <h2 className="text-lg font-semibold text-white mb-4">Companies ล่าสุด</h2>
        ...
        <p className="text-center text-slate-400 py-20">ไม่สามารถโหลดข้อมูลได้</p>
      )}
    </SuperAdminLayout>
  );
}
