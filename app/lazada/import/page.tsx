...
function LazadaImportContent() {
  ...
  const accountName = searchParams.get('account_name') || 'Lazada';

  const [items, setItems] = useState<LazadaImportItem[]>([]);
  ...
  const loadPreview = useCallback(async () => {
    ...
    setLoadError(null);
    try {
      const res = await apiFetch(`/api/lazada/products/import?account_id=${accountId}&page_size=20`);
        ...
        <DoneCard
          ...
          summary={
            <div className="flex flex-wrap justify-center gap-2">
              ...
              <Badge tone="indigo">{summary.links_created} ผูกกับ Lazada</Badge>
          ...
          <Card>
            ...
            {loading ? (
              ...
              <EmptyCard
                ...
                subtitle="ร้าน Lazada นี้ยังไม่มีสินค้าที่เผยแพร่อยู่"
              />
            ) : (
              <div className="space-y-2">
                {items.map(item => (
