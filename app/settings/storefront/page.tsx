              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    {/* ⚠️ ของเดิมเขียนว่า "ตอบ 404" ซึ่งไม่จริง — ไม่มี notFound() ในหน้าร้านเลย
                        ปิดอยู่จะตอบ 200 พร้อมหน้า "ปิดรับออร์เดอร์" และสั่ง noindex ทุกหน้า */}
                    <p className="section-desc">
                      ปิดอยู่ = ทุกหน้าของร้านแสดงว่าปิดอยู่ ข้อมูลสินค้าไม่หลุดออกไปไหน
                      และ<strong>ถอนออกจาก Google ทั้งร้าน</strong> · ปิดชั่วคราวไม่กี่วัน
                      ให้ใช้ &quot;พักรับออร์เดอร์&quot; ข้างล่างแทน
                    </p>
                  </div>
                </div>
                <Toggle
