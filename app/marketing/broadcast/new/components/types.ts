...
export interface BroadcastAccount {
  ...
  /**
   * ตั้งค่าบรอดแคสต์ของบัญชี **ใบนี้** ครบหรือยัง — Facebook ต้องผูกบัญชีโฆษณา + ตั้งงบก่อน
   * (ข้อความการตลาดคิดเงินต่อข้อความ) · ช่องทางที่ไม่ต้องตั้งค่ารายบัญชีเป็น true เสมอ
   * ยังไม่พร้อม = โชว์ในลิสต์แต่ติ๊กไม่ได้ พร้อมทางไปตั้งค่า — **ห้ามซ่อน**
   */
